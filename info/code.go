...
// The standard ASDU labels specified over here follow a hierarchical order.
// At the root you'll find M for monitored information, C for control
// information, P for parameter and F for file transfer.
const (
